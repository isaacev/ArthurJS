exports.grammar = {
	bnf: {
		...
		Try: [
			...
			['TryBlock CatchBlock', '$$ = $1.addCatch($2);'],
			['TryBlock FinallyBlock', '$$ = $1.addFinally($3);'],
			['TryBlock CatchBlock FinallyBlock', '$$ = $1.addCatch($2).addFinally($3);']
		],

		TryBlock: [
			['TRY : Block', '$$ = new yy.Try($3);']
		],

		CatchBlock: [
			['CATCH ( Identifier ) : Block', '$$ = {id: $3, block: $6};']
		],
